    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='../static/images/default.png', upload_to='users/%Y/%m/%d', verbose_name='Фото')),
                ('slug', models.SlugField(blank=True, verbose_name='URL')),
                ('sensor', models.ManyToManyField(blank=True, to='esp_sensor.sensor', verbose_name='Пользователь')),
